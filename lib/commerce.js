...
export const commerce = new Commerce( checAPIKey, devEnvironment );

const res = async () => await commerce.products.list().then((prod) => console.log(prod)).catch(err => console.log(err))
